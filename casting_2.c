...
/*   Updated: 2023/11/21 17:31:14 by vcereced         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (0 <= data->cast.current_x_cell && 0 <= data->cast.current_y_cell && data->map.height > data->cast.current_y_cell && data->map.width > data->cast.current_x_cell)//HARCODED A 10!!!!!!!!
		return (1);
	return (0);
}
